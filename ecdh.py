...
if __name__ == "__main__":
    ...
    bpriv = int(raw_input())#3
    bpub = dh.gen(bpriv)
    print " Public key is",bpub
...
# generate a random secret key and take its x
x,y= dh.secret(bpriv,apub)
secret=x+y
print"\n Using x+y cordinate of shared key = " ,secret

secret = hashlib.md5('secret').hexdigest()
print "\n Calculating its md5 key = ", secret
# create a cipher object using the random secret
print"\n Now using AES and ECDH"
